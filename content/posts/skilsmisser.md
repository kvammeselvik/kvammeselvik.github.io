...
Kva skala er det då som skal brukast på andreaksen? Kanskje det er "antal"? Det går an å sjekke. Eg kan lese av alle punkta som er markert, og gi kvart punkt ein verdi som er \\(k\cdot y\_i)\\) der \\(y\_i\\) er verdien på andreaksen. Så summerer eg alle desse, og set summen lik 10 000:
...
\\]
og så setje denne inn. Når eg (etter beste evne) les av grafen får eg at \\(\sum\_{i=1}^{65}y\_i=705\\), som gir \\(k=14,1844\\), og dei avmerka punkta på grafen tilsvarer då
